...
const Terms = () => {
  return (
    <>
      <Head>
        <title>Megabyt Terms &amp; Conditions</title>
      </Head>
      <div className="container mx-auto mb-10">
        <Link href="/">
          <div className="py-6 font-bold text-2xl bg-gray-200 w-60 h-10 flex justify-center items-center my-4 rounded-full	cursor-pointer hover:bg-[#3F4CE0] group transition duration-300">
        ...
        <p>
          ...
          related to it, still belong to Megabyt.
        </p>

        <br />
        <p>
          Megabyt is committed to ensuring that the app is as useful and
        ...
        <br />
        <p>
          The Tarana app stores and processes personal data that you have
          ...
          Tarana app won’t work properly or at all.
        </p>
        <br />
        <div>
          <br />
          ...
          <br />
          <ul className="font-medium text-[#3F4CE0]">
            <li>
              <Link
        ...
        <br />
        <p>
          You should be aware that there are certain things that Megabyt will
          ...
          Wi-Fi, or provided by your mobile network provider, but Megabyt cannot
        ...
        <br />
        <p>
          Along the same lines, Megabyt cannot always take responsibility for
          ...
          avail the Service, Megabyt cannot accept responsibility.
        </p>
        <br />
        <p>
          With respect to Megabyt’s responsibility for your use of the app, when
          ...
          it available to you. Megabyt accepts no liability for any loss, direct
        ...
        <p>
          ...
          want to keep using the app. Megabyt does not promise that it will
        ...
        <br />
        <p>These terms and conditions are effective as of 2020-08-15</p>
        <br />
        <p>
        ...
        <p>
          ...
          <a className="font-medium text-[#3F4CE0]" href="mailto:megabytdev@gmail.com">megabytdev@gmail.com</a>.
        </p>
      </div>
    </>
  );
